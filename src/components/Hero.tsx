...
const Hero = () => {
  return (
    <main className='flex flex-col justify-center items-center min-h-screen p-4'>
      ...
      <h1 className='font-abraham text-center uppercase text-6xl sm:text-5xl md:text-6xl lg:text-8xl flex flex-wrap justify-center items-center gap-2 md:gap-4 mb-6 md:mb-10'>
        Lore
        <span className='font-abhaya font-normal text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-1 md:mt-3'> &</span>
        Sergio
      </h1>
      <div className='flex flex-col justify-center items-center text-secondary font-didot uppercase text-base sm:text-xl md:text-2xl text-center font-thin'>
        <span>
